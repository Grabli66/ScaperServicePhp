...
class HxClass {
	...
	public function __construct ($phpClassName) {
		#/home/grabli66/haxe/std/php/Boot.hx:638: characters 3-35
	...
	public function __call ($method, $args) {
		#/home/grabli66/haxe/std/php/Boot.hx:647: characters 3-53
	...
	public function __get ($property) {
		#/home/grabli66/haxe/std/php/Boot.hx:655: lines 655-663
		if (defined("" . ($this->phpClassName??'null') . "::" . ($property??'null'))) {
			#/home/grabli66/haxe/std/php/Boot.hx:656: characters 4-54
			return constant("" . ($this->phpClassName??'null') . "::" . ($property??'null'));
		} else if (Boot::hasGetter($this->phpClassName, $property)) {
			#/home/grabli66/haxe/std/php/Boot.hx:658: characters 29-41
			$tmp = $this->phpClassName;
			#/home/grabli66/haxe/std/php/Boot.hx:658: characters 4-59
			return $tmp::{"get_" . ($property??'null')}();
		} else if (method_exists($this->phpClassName, $property)) {
			#/home/grabli66/haxe/std/php/Boot.hx:660: characters 4-48
			return new HxClosure($this->phpClassName, $property);
		} else {
			#/home/grabli66/haxe/std/php/Boot.hx:662: characters 33-45
			$tmp1 = $this->phpClassName;
			#/home/grabli66/haxe/std/php/Boot.hx:662: characters 4-56
	...
	public function __set ($property, $value) {
		#/home/grabli66/haxe/std/php/Boot.hx:671: lines 671-675
		if (Boot::hasSetter($this->phpClassName, $property)) {
			#/home/grabli66/haxe/std/php/Boot.hx:672: characters 22-34
			$tmp = $this->phpClassName;
			#/home/grabli66/haxe/std/php/Boot.hx:672: characters 4-59
			$tmp::{"set_" . ($property??'null')}($value);
		} else {
			#/home/grabli66/haxe/std/php/Boot.hx:674: characters 26-38
			$tmp1 = $this->phpClassName;
			#/home/grabli66/haxe/std/php/Boot.hx:674: characters 4-56
			$tmp1::${$property} = $value;
		}
	}
}
