...
class File {
	...
	static public function read ($path, $binary = true) {
		#C:\Users\VEgorov\AppData\Roaming/haxe/versions/4.0.0-rc.3/std/php/_std/sys/io/File.hx:48: characters 3-73
		if ($binary === null) {
			$binary = true;
		}
	...
	static public function write ($path, $binary = true) {
		#C:\Users\VEgorov\AppData\Roaming/haxe/versions/4.0.0-rc.3/std/php/_std/sys/io/File.hx:52: characters 3-66
		if ($binary === null) {
			$binary = true;
		}
