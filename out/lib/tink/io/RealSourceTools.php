...
class RealSourceTools {
	...
	static public function all ($s) {
		#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:156: lines 156-159
		return Source_Impl_::concatAll($s)->map(function ($o) {
			$__hx__switch = ($o->index);
			if ($__hx__switch === 1) {
				#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:158: characters 23-33
				return Outcome::Failure($o->params[0]);
			} else if ($__hx__switch === 2) {
				#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:157: characters 24-34
	...
	static public function idealize ($s, $rescue) {
		#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:187: characters 5-69
	...
	static public function parse ($s, $p) {
		#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:162: lines 162-165
		return StreamParser_Impl_::parse($s, $p)->map(function ($r) {
			$__hx__switch = ($r->index);
			if ($__hx__switch === 0) {
				#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:163: characters 32-61
				return Outcome::Success(new MPair($r->params[0], $r->params[1]));
			} else if ($__hx__switch === 1) {
				#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:164: characters 38-48
	...
	static public function parseStream ($s, $p) {
		#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:184: characters 5-42
	...
	static public function split ($src, $delim) {
		#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:168: characters 5-45
		$s = RealSourceTools::parse($src, new Splitter($delim));
		#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:171: lines 171-174
		$tmp = Stream_Impl_::promise(Promise_Impl_::ofSpecific(Promise_Impl_::next($s, Next_Impl_::ofSafeSync(function ($p)  use (&$src) {
			#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:171: characters 116-119
			$_g = $p->a;
			$__hx__switch = ($_g->index);
			if ($__hx__switch === 0) {
				#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:172: characters 27-45
				return new Single(new LazyConst($_g->params[0]));
			} else if ($__hx__switch === 1) {
				#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:173: characters 20-23
				return $src;
			}
		}))));
		#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:175: lines 175-178
		$tmp1 = Promise_Impl_::next($s, function ($p1)  use (&$delim) {
			#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:175: characters 51-54
			$__hx__switch = ($p1->a->index);
			if ($__hx__switch === 0) {
				#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:176: characters 9-28
				return new SyncFuture(new LazyConst(Outcome::Success($delim)));
			} else if ($__hx__switch === 1) {
				#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:177: characters 9-62
		...
		#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:170: lines 170-180
		return new HxAnon([
			"before" => $tmp,
			"delimiter" => $tmp1,
			"after" => Stream_Impl_::promise(Promise_Impl_::ofSpecific(Promise_Impl_::next($s, Next_Impl_::ofSafeSync(function ($p2) {
				#/home/grabli66/haxelib/tink_io/git/src/tink/io/Source.hx:179: characters 101-111
				return $p2->b;
			})))),
		]);
	}
