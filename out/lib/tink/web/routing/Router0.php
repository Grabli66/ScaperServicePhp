...
class Router0 {
	...
	public function __construct ($target) {
		#/home/grabli66/haxelib/tink_web/git/src/tink/web/macros/Routing.hx:218: characters 11-31
		$this->target = $target;
	}
	...
	public function route ($ctx) {
		#/home/grabli66/haxelib/tink_web/git/src/tink/web/macros/Routing.hx:222: characters 11-34
		$l = $ctx->parts->length - $ctx->depth;
		#/home/grabli66/haxelib/tink_web/git/src/tink/web/macros/Routing.hx:140: characters 22-41
		$_g2 = $ctx->part(0);
		#/home/grabli66/haxelib/tink_web/git/src/tink/web/macros/Routing.hx:137: characters 22-39
		if ($ctx->request->header->method === "GET") {
			#/home/grabli66/haxelib/tink_web/git/src/tink/web/macros/Routing.hx:140: characters 22-41
			if ($_g2 === "xpath") {
				#/home/grabli66/haxelib/tink_web/git/src/tink/web/macros/Routing.hx:143: characters 22-31
				if (($l > 0) === true) {
					if (($l > 1) === false) {
						#src/Main.hx:52: characters 8-16
						return Promise_Impl_::ofSpecific($this->parseXpath($ctx));
					} else {
						#src/Main.hx:42: characters 20-32
