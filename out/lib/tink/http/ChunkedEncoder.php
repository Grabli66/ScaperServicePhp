...
class ChunkedEncoder implements Transformer {
	...
	public function transform ($source) {
		#/home/grabli66/haxelib/tink_http/git/src/tink/http/Chunked.hx:38: lines 38-39
		$tmp = Source_Impl_::chunked($source)->map(Mapping_Impl_::ofPlain(function ($chunk) {
			#/home/grabli66/haxelib/tink_http/git/src/tink/http/Chunked.hx:39: characters 43-78
			...
			#/home/grabli66/haxelib/tink_http/git/src/tink/http/Chunked.hx:39: characters 43-87
			$b1 = strlen("\x0D\x0A");
			#/home/grabli66/haxelib/tink_http/git/src/tink/http/Chunked.hx:39: characters 36-87
			return Chunk_Impl_::catChunk($tmp1, ByteChunk::of(new Bytes($b1, new _BytesDataContainer("\x0D\x0A"))));
		}));
		#/home/grabli66/haxelib/tink_http/git/src/tink/http/Chunked.hx:40: characters 13-36
		$b2 = strlen("0\x0D\x0A");
		#/home/grabli66/haxelib/tink_http/git/src/tink/http/Chunked.hx:38: lines 38-40
