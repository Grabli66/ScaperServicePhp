...
final class OutgoingResponse_Impl_ {
	...
	static public function _new ($header, $body) {
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:65: character 3
	...
	static public function blob ($code = 200, $chunk, $contentType, $headers = null) {
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:69: lines 69-82
		if ($code === null) {
			$code = 200;
		}
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:73: characters 13-17
		$this1 = HttpStatusMessage_Impl_::fromCode($code);
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:75: characters 15-59
		$fields = new HeaderField(HeaderName_Impl_::ofString("Content-Type"), $contentType);
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:76: characters 32-46
		$fields1 = HeaderName_Impl_::ofString("Content-Length");
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:71: lines 71-80
		...
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:70: lines 70-82
	...
	static public function ofChunk ($c) {
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:93: characters 5-47
	...
	static public function ofString ($s) {
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:90: characters 17-18
		$b = strlen($s);
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:90: characters 5-33
	...
	static public function reportError ($e) {
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:97: characters 7-96
		...
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:98: lines 98-102
		$s = Json::phpJsonEncode(new HxAnon([
			"error" => $e->message,
			"details" => $e->data,
		]), null, null);
		$b = strlen($s);
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:96: lines 96-103
