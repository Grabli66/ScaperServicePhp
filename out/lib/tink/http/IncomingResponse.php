...
class IncomingResponse extends Message {
	...
	static public function readAll ($res) {
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:110: lines 110-116
		return Promise_Impl_::next(RealSourceTools::all($res->body), function ($b)  use (&$res) {
			#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:112: lines 112-115
			if ($res->header->statusCode >= 400) {
				#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:113: characters 11-90
				...
				#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:115: characters 11-21
	...
	static public function reportError ($e) {
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:120: characters 7-96
		...
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:121: lines 121-125
		$s = Json::phpJsonEncode(new HxAnon([
			"error" => $e->message,
			"details" => $e->data,
		]), null, null);
		$b = strlen($s);
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:119: lines 119-126
	...
	public function __construct ($header, $body) {
		#C:/Users/VEgorov/AppData/Roaming/haxe/haxe_libraries/tink_http/0.8.2/haxelib/src/tink/http/Response.hx:107: lines 107-129
